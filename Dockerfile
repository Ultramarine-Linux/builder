...
RUN \
    ...
    dnf5 in -y --nogpgcheck --repo=terra,ultramarine --setopt=terra.baseurl='https://repos.fyralabs.com/terra$releasever',terra.metalink=,ultramarine.baseurl='https://repos.fyralabs.com/um$releasever',ultramarine.metalink= terra-gpg-keys ultramarine-gpg-keys &&\
    dnf5 up -y &&\
